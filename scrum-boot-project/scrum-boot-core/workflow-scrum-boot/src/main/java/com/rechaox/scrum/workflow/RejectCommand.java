...
import com.rechaox.scrum.util.CollectionUtils;
 ...
 * @since 2021/09/27
 */
public class RejectCommand implements Command<Void> {

    private final String taskId;
    private final String rejectReason;
    private final Map<String, Object> variables;

    public RejectCommand(String taskId, Map<String, Object> variables, String rejectReason) {
        this.taskId = taskId;
